...
uint32_t u1tcFlag = 0;  // USART1 Transmite complete flag
...
int main(void) {
    ...
    while (1) {
        ...
        GPIOA->ODR ^= 0x20;  //  Blink led indicate program is running
        delay_ms(1000);
    }
    return 0;
}
